...
} from '../../shared/components/instagram-gallery/instagram-gallery.component';
...
@Component({
  selector: 'app-about',
  imports: [TranslateModule, TileGridComponent, InstagramGalleryComponent, AboutSkillsComponent],
